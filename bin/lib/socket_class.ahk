; http://www.autohotkey.com/board/topic/94376-socket-class-überarbeitet/?hl=udp
class Socket
{
  ...
  __getAddrInfo(host, port)
  {
    ...
    , addr_any6:a[5], inaddr_any:5[5], addr_broadcast6:a[6], inaddr_broadcast6:a[6], addr_none6:a[6], inaddr_none6:a[6]}
    if (conv[host])
      host := conv[host]
